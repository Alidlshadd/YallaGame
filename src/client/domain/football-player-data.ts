...
const GOAT_PLAYER_NAMES = new Set<string>([
  /* All-time top tier — modern + historical greats. */
  "Lionel Messi", "Cristiano Ronaldo", "Pele", "Diego Maradona", "Ronaldo Nazario",
  "Zinedine Zidane", "Ronaldinho", "Johan Cruyff", "Franz Beckenbauer", "Alfredo Di Stefano",
  "Ferenc Puskas", "Eusebio", "Gerd Muller", "George Best", "Michel Platini",
  "Bobby Charlton", "Bobby Moore", "Lev Yashin", "Dino Zoff", "Garrincha",
  "Roberto Baggio", "Romario", "Marco van Basten", "Andriy Shevchenko", "Thierry Henry",
  "Ruud Gullit", "Marcel Desailly", "Lilian Thuram", "Patrick Vieira", "Claude Makelele",
  "Xavi", "Andres Iniesta", "Luka Modric", "Andrea Pirlo", "Kaka",
  "Carles Puyol", "Sergio Busquets", "Sergio Ramos", "Gerard Pique", "Dani Alves",
  "Iker Casillas", "Gianluigi Buffon", "Manuel Neuer", "Paolo Maldini", "Franco Baresi",
  "Alessandro Nesta", "Fabio Cannavaro", "Giorgio Chiellini", "Leonardo Bonucci", "Javier Zanetti",
  "Cafu", "Roberto Carlos", "Carlos Alberto", "Nilton Santos", "Junior",
  "Socrates", "Rivaldo", "Jairzinho", "Bebeto", "Ronaldo de Lima",
  "Adriano", "Hristo Stoichkov", "Gabriel Batistuta", "Hernan Crespo", "Juan Roman Riquelme",
  "Daniel Passarella", "Mario Kempes", "Sergio Aguero", "Carlos Tevez", "David Beckham",
  "Wayne Rooney", "Paul Scholes", "Steven Gerrard", "Frank Lampard", "Roy Keane",
  "Rio Ferdinand", "John Terry", "Ashley Cole", "Sol Campbell", "Peter Schmeichel",
  "Edwin van der Sar", "Dennis Bergkamp", "Patrick Kluivert", "Ruud van Nistelrooy", "Edgar Davids",
  "Frank Rijkaard", "Clarence Seedorf", "Wesley Sneijder", "Robin van Persie", "Arjen Robben",
  "Virgil van Dijk", "Eric Cantona", "Ian Rush", "Kenny Dalglish", "Alan Shearer",
  "Gary Lineker", "Michael Owen", "Teddy Sheringham", "Eden Hazard", "Didier Drogba",
  "Samuel Eto'o", "Luis Suarez", "Zlatan Ibrahimovic", "Edinson Cavani", "Radamel Falcao",
  "Diego Forlan", "Karim Benzema", "Antoine Griezmann", "Kylian Mbappe", "Neymar",
  "Erling Haaland", "Robert Lewandowski", "Mohamed Salah", "Sadio Mane", "Harry Kane",
  "Vinicius Junior", "Jude Bellingham", "Kevin De Bruyne", "Bruno Fernandes", "Phil Foden",
  "Son Heung-min", "Toni Kroos", "Bastian Schweinsteiger", "Thomas Muller", "Marco Reus",
  "Philipp Lahm", "Oliver Kahn", "Sepp Maier", "Lothar Matthaus", "Karl-Heinz Rummenigge",
  "Uwe Seeler", "Gianni Rivera", "Sandro Mazzola", "Giacinto Facchetti", "Gaetano Scirea",
  "Giuseppe Meazza", "Paolo Rossi", "Alessandro Del Piero", "Francesco Totti", "Gianfranco Zola",
  "Lorenzo Insigne", "Luis Figo", "Rui Costa", "Pepe", "Ricardo Carvalho",
  "Predrag Mijatovic", "Davor Suker", "Zvonimir Boban", "Brian Laudrup", "Michael Laudrup",
  "Henrik Larsson", "Marek Hamsik", "Hakan Sukur", "George Weah", "Roger Milla",
  "Jay-Jay Okocha", "Yaya Toure", "Christian Eriksen", "Gareth Bale", "Andrew Robertson",
  "Trent Alexander-Arnold", "N'Golo Kante", "Paul Pogba", "Casemiro", "Marquinhos",
  "Achraf Hakimi", "Ousmane Dembele", "Antoine Griezmann", "Pedri", "Gavi",
  "Lamine Yamal", "Federico Valverde", "Eduardo Camavinga", "Aurelien Tchouameni",
  "Florian Wirtz", "Jamal Musiala", "Joshua Kimmich", "Khvicha Kvaratskhelia",
  "Victor Osimhen", "Lautaro Martinez", "Julian Alvarez", "Rafael Leao",
  "Dejan Stankovic", "Nemanja Vidic", "Branislav Ivanovic", "Mateo Kovacic", "Ivan Rakitic",
  "Pavel Nedved", "Petr Cech", "Tomas Rosicky", "Patrik Schick",
  "Gheorghe Hagi", "Carlos Valderrama", "Enzo Francescoli", "Hugo Sanchez", "Jorge Campos",
  "Jose Luis Chilavert", "Claudio Taffarel", "Rene Higuita", "Ubaldo Fillol",
  "Lev Yashin", "Andrey Arshavin"
])
